...
//	public abstract int updateParam(Map param);
	 ...
	 * @return
	 */
	public abstract int deleteParam(T entity);
	 ...
	 */
	public abstract List<T> selectParam(T entry);
	 ...
	 */
	public abstract PagingResult<T> selectPagination(PageEntity<T> pageEntity);
