...
<body style="background-color:#ffffff;">
	...
	<table class="tableStyle" formMode="transparent">
		...
		<tr>
			<td>自动完成框：</td><td> <input type="text" class="autoComplete" url="<%=path%>/autoComplateAction.do?method=getListByEmail" params='{"userAge": "26", "userSex": "1"}' matchName="userName"/></td>
		</tr>
		<tr>
