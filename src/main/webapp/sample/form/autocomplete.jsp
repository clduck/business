...
<body>
  ...
  <fieldset>
      ...
      <input type="text" class="autoComplete" url="<%=path%>/form/getItemListByWord.action"/>
  ...
  <fieldset>
      <legend>2、通过url+参数获取数据源</legend>
       <div class="red">此示例由后台支持</div>
      <p>输入邮箱地址。</p>
      <input type="text" class="autoComplete" url="<%=path%>/form/getItemListByEmail.action" params='{"userAge": "26", "userSex": "1"}' matchName="userName"/>
  ...
  <div class="height_15"></div>
   ...
   <fieldset>
      ...
      <input type="text" class="autoComplete" url="<%=path%>/form/getItemListByChar.action" minChars="2" limit="50"/>
  ...
  <fieldset>
      ...
      <input type="text" class="autoComplete" url="<%=path%>/form/getItemListByChar.action" />
  </fieldset>
   <div class="height_15"></div>
   ...
   <fieldset>
      <legend>6、自定义尺寸</legend>
       <div class="red">此示例由后台支持</div>
    	<p>输入邮箱地址。</p>
      <input type="text" class="autoComplete" url="<%=path%>/form/getItemListByEmail.action" matchName="userName" inputWidth="250" boxWidth="250"/>
  </fieldset>
  <div class="height_15"></div>
  ...
  <fieldset>
      <legend>7、多列提示</legend>
       <div class="red">此示例由后台支持</div>
      <p>输入“红”测试。</p>
      <input type="text" class="autoComplete" url="<%=path%>/form/getItemListByMutiCols.action" boxWidth="250" colMulti="true" colIdx="0"/>
  ...
  <fieldset>
      <legend>8、禁用/启用</legend>
       <div class="red">此示例由后台支持</div>
      <p>可分别输入”S“，“HS”，“SL”，“SZ”测试（不区分大小写）。</p>
       <input type="text" class="autoComplete" url="<%=path%>/form/getItemListByChar.action" disabled="true"  id="input-8"/>
...
<script type="text/javascript">
	...
	function initComplete(){
		...
		$('#input-10').AutoComplete({
			url: '<%=path%>/form/getItemListByChar.action',
	...
	function dynamic(){
		...
		$auto.attr("url","<%=path%>/form/getItemListByChar.action");
		$("#testBtn").after($auto);   
		$("#testBtn").after($("<br/>"));   
		//渲染
		$auto.render();      
