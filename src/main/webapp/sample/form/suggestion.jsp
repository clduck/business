...
<div class="box1" panelWidth="800">
  ...
  <fieldset>
      ...
      <div class="suggestion" keepDefaultStyle="true" id="suggestion4" url="<%=path%>/form/getListOfCity.action" showList="true"></div>
      <br/>
  ...
  <fieldset>
      ...
      <div class="suggestion" id="suggestion5" showMultiList="true" multiListWidth="300"></div>
      <br/>
   ...
   <div class="height_15"></div>
    ...
    <fieldset>
      ...
      仿网易邮箱的邮件查询。点击按钮在新窗口查看<br/>
		<input type="button" value="打开" onclick='top.Dialog.open({URL:"<%=path%>/sample/form/suggestion-content.jsp",Title:"示例",Width:"100",Height:"100",Modal:true});'/> 
  </fieldset>
   <div class="height_15"></div>
<script>
var listdata={"list":[
